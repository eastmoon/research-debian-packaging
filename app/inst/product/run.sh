...
CLI_SHELL_DIRECTORY=${CLI_DIRECTORY}/.conf/cli
SHELL_FILE=
...
EXECUTE_ERROR_CHECK=
EXECUTE_DISABLE_IWA=
[ -e ${CLI_DIRECTORY}/.conf/.runattribute ] && source ${CLI_DIRECTORY}/.conf/.runattribute
...
function cli-help() {
    ...
    echo "    --module, -m      Assign module execute ( Default is all module )."
    command-description
}
